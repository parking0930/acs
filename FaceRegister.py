...
if __name__ == "__main__":
    ...
    while True:
        p_number = input("사원번호 : ")
        request_data = requests.get("http://192.168.0.61:8081/infoserver/selectAuthorized?id="+p_number)
    ...
    result = requests.post("http://192.168.0.61:8081/infoserver/register", data=response_data)
    # print(result)
